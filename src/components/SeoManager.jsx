...
const canonicalRouteMap = {
  ...
  "/automotive-data": "/services/automotive",
  "/automotive-engineering-services": "/services/automotive",
  "/aerospace-data": "/services/aerospace",
  "/aerospace-engineering-services": "/services/aerospace",
